...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Alunos - Cadastro</h1>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="color_declaration" class="form-control">
                                    ...
                                    <option value="3" {{ old('color_declaration') == '3' ? 'selected' : '' }}>Amarelo
                                    </option>
                                    <option value="4" {{ old('color_declaration') == '4' ? 'selected' : '' }}>Negro
                                    </option>
                                    <option value="5" {{ old('color_declaration') == '5' ? 'selected' : '' }}>Branco
                                    </option>
                                    <option value="6" {{ old('color_declaration') == '6' ? 'selected' : '' }}>Preto
                                    </option>
                                    <option value="7" {{ old('color_declaration') == '7' ? 'selected' : '' }}>Pardo
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="observation">Observações textuais</label>
                                <textarea class="form-control" rows="2" name="observation">{{ old('observation') }}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
