                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="teacher_admin" value="0"
                                            {{ old('teacher_admin') == '0' ? 'checked' : ($user->teacher_admin == 0 ? 'checked' : '') }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="teacher_admin" value="1"
                                            {{ old('teacher_admin') == '1' ? 'checked' : ($user->teacher_admin == 1 ? 'checked' : '') }}>
                                        <label class="form-check-label" for="teacher_admin">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control mask-document" name="document"
                                    placeholder="Ex: 000.000.000-00" value="{{ old('document') ?? $user->document }}">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select name="genre" class="form-control">
                                    ...
                                    <option value="1"
                                        {{ old('genre') == '1' ? 'selected' : ($user->genre == 1 ? 'selected' : '') }}>
                                        Homem</option>
                                    <option value="2"
                                        {{ old('genre') == '2' ? 'selected' : ($user->genre == 2 ? 'selected' : '') }}>
                                        Mulher</option>
                                    <option value="3"
                                        {{ old('genre') == '3' ? 'selected' : ($user->genre == 3 ? 'selected' : '') }}>
                                        Ambos</option>
                                    <option value="4"
                                        {{ old('genre') == '4' ? 'selected' : ($user->genre == 4 ? 'selected' : '') }}>
                                        Nenhum</option>
                                    <option value="5"
                                        {{ old('genre') == '5' ? 'selected' : ($user->genre == 5 ? 'selected' : '') }}>
                                        Prefiriu não
                                        informar</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control mask-birth_date" name="birth_date"
                                    placeholder="Ex: 00/00/0000" value="{{ old('birth_date') ?? $user->birth_date }}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control mask-telephone" name="telephone"
                                    placeholder="(00) 00000-0000" value="{{ old('telephone') ?? $user->telephone }}">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="whatsapp" value="1"
                                            {{ old('whatsapp') == '1' ? 'checked' : ($user->whatsapp == 1 ? 'checked' : '') }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="whatsapp" value="0"
                                            {{ old('whatsapp') == '0' ? 'checked' : ($user->whatsapp == 0 ? 'checked' : '') }}>
                                        <label class="form-check-label" for="whatsapp">
                                            Não
                                        </label>
                                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="graduation" class="form-control">
                                    <option selected>Selecione</option>
                                    <option value="1"
                                        {{ old('graduation') == '1' ? 'selected' : ($user->graduation == 1 ? 'selected' : '') }}>
                                        Graduando</option>
                                    <option value="2"
                                        {{ old('graduation') == '2' ? 'selected' : ($user->graduation == 2 ? 'selected' : '') }}>
                                        Graduado</option>
                                    <option value="3"
                                        {{ old('graduation') == '3' ? 'selected' : ($user->graduation == 3 ? 'selected' : '') }}>
                                        Especialista
                                    </option>
                                    <option value="4"
                                        {{ old('graduation') == '4' ? 'selected' : ($user->graduation == 4 ? 'selected' : '') }}>
                                        Mestrando</option>
                                    <option value="5"
                                        {{ old('graduation') == '5' ? 'selected' : ($user->graduation == 5 ? 'selected' : '') }}>
                                        Mestre</option>
                                    <option value="6"
                                        {{ old('graduation') == '6' ? 'selected' : ($user->graduation == 6 ? 'selected' : '') }}>
                                        Doutorando
                                    </option>
                                    <option value="7"
                                        {{ old('graduation') == '7' ? 'selected' : ($user->graduation == 7 ? 'selected' : '') }}>
                                        Doutor(a)</option>
                                    <option value="8"
                                        {{ old('graduation') == '8' ? 'selected' : ($user->graduation == 8 ? 'selected' : '') }}>
                                        Pós-Doutorando
                                    </option>
                                    <option value="9"
                                        {{ old('graduation') == '9' ? 'selected' : ($user->graduation == 9 ? 'selected' : '') }}>
                                        Pós-Doutor(a)
                                    </option>
                                </select>
                            </div>
                                ...
                                <select class="form-control js-example-basic-multiple" name="discipline_id[]"
                                    ...
                                    @foreach ($disciplines as $discipline)
                                        <option value="{{ $discipline->id }}"
                                            @foreach ($user->disciplines as $d) @if ($discipline->id == $d->id)
